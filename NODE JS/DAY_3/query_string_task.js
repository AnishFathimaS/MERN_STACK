                        ...
                        <form action="/submit" method="POST">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input value="John" type="text" name="fname">
                                </div>
                                <div class="col-6">
                                    <label>Enter Last Name</label>
                                    <input value="Doe" type="text" name="lname">
                                </div>
                                <div class="col-6">
                                    <label>Enter Gmail</label>
                                    <input value="johndoe@gmail.com" type="mail" name="mail">
                                </div>
                                <div class="col-6">
                                    <label>Enter Password</label>
                                    <input value="123" type="password" name="pw">
                                </div>
                                <div class="col-6">
                                    <label>Enter Confrim Password</label>
                                    <input value="123" type="password" name="cpw">
                                </div>
                                <div class="col-6">
                                ...
                                <div class="col-6">
                                    ...
                                    <input value="Male" type="text" name="gender">
                                </div>
                                <div class="col-6">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="date" name="dob" value="2025-03-31"><br><br>
                                </div> 
                            </div>  
                            <center>         
